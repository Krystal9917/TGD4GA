...
class Args:
    def __init__(self):
        ...
        parser.add_argument('--model_states_path', type=str, default=os.path.abspath(
            os.path.join(os.path.dirname(__file__), os.path.pardir, "data", "saved_model",
...
class ArgsSeqGraph:
    def __init__(self):
        ...
        parser.add_argument('--action_vocab_path', type=str, default=os.path.abspath(
            os.path.join(os.path.dirname(__file__), os.path.pardir, "data", "config", "vocabulary",
                         "uin2uin_action_vocab" + ".txt"))),
        parser.add_argument('--uin_seqs_enum_yaml_path', type=str, default=os.path.abspath(
            os.path.join(os.path.dirname(__file__), os.path.pardir, "data", "config", "yml",
                         "uin_seqs_enum" + ".yaml"))),
        parser.add_argument('--model_states_path', type=str, default=os.path.abspath(
